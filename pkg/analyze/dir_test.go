...
func TestHardlink(t *testing.T) {
	...
	if err != nil {
		t.Skip("Hardlinks may require elevated privileges on Windows")
	}
	...
	// On Windows, hardlink detection may work differently
	if runtime.GOOS == "windows" {
		// Just verify the hardlink was created and analyzed
